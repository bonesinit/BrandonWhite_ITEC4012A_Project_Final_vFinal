...
class Character(models.Model):
    ...
    # I know this SHOULD be user = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.CASCADE), but I am not going to
    # go back and break my project to change it
